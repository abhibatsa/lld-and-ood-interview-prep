...
```
![Class Objects Car Example](../assets/classes-objects-car-example.png)

Let's understand with another simple example:

![Class Objects Cookies Example](../assets/classes-objects-cookies-example.png)
